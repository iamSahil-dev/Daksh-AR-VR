  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: 'Welcome to DAKSH. Redirecting to dashboard...',
      });
      setIsLoading(false);
      navigate('/dashboard');
    }, 1500);
      ...
      >
        ...
        <Link to="/" className="flex items-center justify-center gap-3 mb-8">
          <div className="relative">
            ...
            <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-primary via-secondary to-accent blur-lg opacity-50" />
          </div>
        ...
        <div className="glass-panel rounded-2xl p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Start your immersive learning journey</p>
            </div>
                    ...
                    {passwordRequirements.map((req, index) => (
                      <div
                        ...
                        className={`flex items-center gap-2 text-xs ${
                          req.met ? 'text-neon-green' : 'text-muted-foreground'
                        }`}
                      >
